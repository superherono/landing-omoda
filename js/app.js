 ...
 */
    ...
    (() => {
        ...
        let today = new Date, dd = String(today.getDate()).padStart(2, "0"), mm = String(today.getMonth() + 1).padStart(2, "0"), yyyy = today.getFullYear(), nextYear = yyyy + 1, dayMonth = "10/11/", birthday = dayMonth + yyyy, currentDate = new Date("October 11, 2022 18:30:00");
        today = mm + "/" + dd + "/" + yyyy;
        ...
        const getRemaningTime = function() {
            ...
            dayBlock.innerText = Math.floor(distance / day), hoursBlock.innerText = Math.floor(distance % day / hour), 
        ...
        const countDown = new Date(currentDate).getTime(), x = setInterval((function() {
            getRemaningTime();
        }), 1e3 * 60);
        getRemaningTime();
        window["FLS"] = true;
